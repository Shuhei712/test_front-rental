      ...
      <div class="content px-2 px-lg-0">
        ...
        <div class="detail__information mt-15">
          <div class="information__menu">
            <p class="d-flex d-sm-none justify-center text-caption text-md-body-2 text-gray mb-0 pa-2 pa-lg-0">クリックでページ内項目にジャンプします</p>
            <ul class="d-flex flex-wrap justify-space-between justify-sm-center pt-5 pt-sm-3 pl-4 pl-sm-5 pl-md-16 text-body-2 text-md-body-1">
              <li class="mr-4 mr-sm-5 mr-md-16 mb-5 mb-sm-3">
                <a v-scroll-to="{ el: '#product-info', offset: -200 }" class="d-flex align-center text-gray hover-opacity">
                  <v-icon class="mr-2" color="primary">mdi-information-outline</v-icon>製品情報<v-icon color="#878787">mdi-chevron-down</v-icon>
                </a>
              </li>
              <li class="mr-4 mr-sm-5 mr-md-16 mb-5 mb-sm-3">
                <a v-scroll-to="{ el: '#product-specification', offset: -200 }" class="d-flex align-center text-gray hover-opacity">
          ...
          <div class="information__content">
            <section id="product-info" class="product-info content__sec mt-15">
              <div class="content__head product-info__head d-flex flex-column flex-sm-row align-center justify-center text-h6 text-sm-h5 font-weight-medium letter-space-02em text-gray">
            ...
            <section id="product-specification" class="product-specification content__sec mt-15">
              <div class="content__head product-specification__head d-flex flex-column flex-sm-row align-center justify-center text-h6 text-sm-h5 font-weight-medium letter-space-02em text-gray">
            ...
            <section v-if="productDocLists !== null" id="product-document" class="product-document content__sec mt-15">
              <div class="content__head product-document__head d-flex flex-column flex-sm-row align-center justify-center text-h6 text-sm-h5 font-weight-medium letter-space-02em text-gray">
            ...
            <section v-if="productRefLists !== null" id="product-related" class="product-related content__sec mt-15">
              <div class="content__head product-related__head d-flex flex-column flex-sm-row align-center justify-center text-h6 text-sm-h5 font-weight-medium letter-space-02em text-gray">
