    ...
    <div class="sec__inner py-16 order">
      <div class="order__status">
        ...
        <div class="pa-2">
          ...
          <p v-if="order.OrderEnableFlg===2" class="red--text mt-3">
            ...
            回答見積書の有効期限が切れており、ご注文を確定することができません。<br>ご注文の確定を希望される場合は、レンタルスタッフまで<nuxt-link :to="'/myaccount/other/contact?orderId='+order.OrderNo" class="link">お問い合わせ</nuxt-link>ください。
          </p>
          <p v-if="order.OrderEnableFlg===9" class="red--text mt-3">
            ...
            本システムでは、レンタルお引渡し日の5営業日前より後のご注文の確定を受け付けておりません。<br>ご注文の確定を希望される場合は、レンタルスタッフまで<nuxt-link :to="'/myaccount/other/contact?orderId='+order.OrderNo" class="link">お問い合わせ</nuxt-link>ください。
          </p>
        </div>
      ...
      <div class="order__item mt-15">
        ...
        <template v-if="order.CancelEnableFlg !== 1">
          ...
          <p>本システムでは、レンタルお引渡し日の5営業日前より後のキャンセルを受け付けておりません。<br>注文をキャンセルする場合は、レンタルご利用ガイドから「<NuxtLink :to="{ path: '/guide/cancel', hash: '#cancel-3' }" class="link" target="_blank">注文後のキャンセルについて</NuxtLink>」をご確認いただき、<span class="d-inline-block">レンタルスタッフまで<nuxt-link :to="'/myaccount/other/contact?orderId='+order.OrderNo" class="link">お問い合わせ</nuxt-link>ください。</span></p>
        </template>
      </div>
    </div>
