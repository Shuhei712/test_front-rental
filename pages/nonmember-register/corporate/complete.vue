      ...
      <v-card max-width="690" class="mx-auto" elevation="0">
        ...
        <v-card-text class="text--text text-body-1">
          <p v-if="err" class="red--text mb-4 text-center">
            ...
            <v-btn color="primary" class="mt-4" @click="$router.push('/nonmember-register/corporate/input')">フォームに戻る</v-btn>
          </p>
          <p v-else>
...
export default {
  ...
  fetch() {
    ...
    }else this.$router.push('/nonmember-register/corporate/input')
