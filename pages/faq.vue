      ...
      const faqList = [
        ...
        },
        {
          ...
          "SubFaqList": [
            ...
            {
              "questionNo": 203,
              "question": "2日間以上レンタルする場合、レンタル代金はどうなりますか？",
          ...
          "SubFaqList": [
            {
              ...
              "answer": "弊社に直接来社・宅配便・チャーター便の3種から選択できます。",
              "detailList": [
                this.getBtnInfo("guide", "rental", 6)
              ]
            },
            ...
            {
              "questionNo": 305,
              "question": "返却できないまま返却日を越えてしまう（延滞する）とどうなりますか？",
        ...
        },
        {
          ...
          "SubFaqList": [
            ...
            },
            {
              ...
              "answer": "既にお客様登録済の方は本人確認不要です。お問い合わせよりご連絡ください。",
              "detailList": [
          ...
          "SubFaqList": [
            {
              ...
              "detailList": [
                {
                  "detailNo": 1,
                  "detailTitle": "お問い合わせフォーム",
                  "detailURL": "https://www.takenaka-co.co.jp/contact/product_form/input.php",
                },
                this.getBtnInfo("link", 2),
              ]
            },
  ...
  methods: {
    ...
    getBtnInfo(json, key, sectionId) {
      if (json === "guide") {
        ...
        return section ? { detailTitle: section.title, detailURL: `/guide/${key}#${section.id}` } : null;
      }
      if (json === "link") {
...
.faq {
  ...
  &-item {
    ...
    &__header {
      &::after {
        background-image: url('~static/img/guide/faq/faq_q_icon.svg');
    ...
    &__content {
      &::after {
        content: '';
        background-image: url('~static/img/guide/faq/faq_a_icon.svg');
