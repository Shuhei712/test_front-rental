<template>
  <section v-if="!$fetchState.pending && !$fetchState.error">
    ...
    <div class="sec__inner py-16">
      ...
      <div v-else>
        <div v-if="errFlg" class="activate__err text-center pb-9">
          <p v-if="(errFlg===110802)" class="red--text text-left text-md-center">既にパスワード変更の処理が行われました。</p>
          <p v-else-if="(errFlg===110804)" class="red--text text-left text-md-center">現在のパスワードが正しくありません</p>
          <div v-else>
