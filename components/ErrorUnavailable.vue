<template>
  <div class="loading">
    ...
    <div class="loading__inner">
      ...
      <div class="loading__text text-h5 text-sm-h4 text-white letter-space-015em">Sorry... Not Found.</div>
      <div class="text-white mt-5 mb-3">
        申し訳ございません。ページが見つかりませんでした。<br>
        お探しの商品は、取り扱いが終了したか、URLが変更されている可能性があります。<br>
        お手数ですが、トップまたはメニューよりページをお探しください。
      </div>
